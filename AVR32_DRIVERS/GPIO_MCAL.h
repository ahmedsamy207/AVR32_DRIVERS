...
//====================================High Nibble============================================
	...
	Function Returns	 : void
	Function Arguments	 : unsigned char port name,unsigned char direction
	Function Description : Set the direction of the highest four pins of the given port as output to connect the 7segment
	*/
	...
	Function Description : Set the value in the highest four pins of the given port (output value 0 = low : 1 = high)
	*/
...
//===================================Low Nibble==============================================
	...
	Function Returns	 : void
	Function Arguments	 : unsigned char port name,unsigned char direction
	Function Description : Set the direction of the lowest four pins of the given port as output to connect the 7segment
	*/
	...
	Function Returns	 : void
	Function Arguments	 : unsigned char port name,unsigned char output value
	Function Description : Set the value in the lowest four pins of the given port (output value 0 = low : 1 = high)
	*/
